...
(function (RongIMLib) {
    var RongIMClient = (function () {
        ...
        */
         ...
         * @param {number} timestamp 指定删除该时间戳之前的消息
         * @param {boolean} cleanSpace 是否清理数据条目所使用的磁盘空间。清理磁盘空间会阻塞进程且耗时较长，不推荐使用。
         * 数据在被抹除的情况下，未清理的磁盘空间会在后续存储操作中复用，且对数据查询无影响
         * @param {Function} callback
         */
        RongIMClient.prototype.deleteLocalMessagesByTimestamp = function (conversationType, targetId, timestamp, cleanSpace, callback) {
            RongIMClient._dataAccessProvider.deleteLocalMessagesByTimestamp(conversationType, targetId, timestamp, cleanSpace, callback);
        };
...
(function (RongIMLib) {
    ...
    var _topic = [
        ...
        "qnUrl", "aliUrl", "qryVoipK", "delMsg", "qryCHMsg", "getUserStatus", "setUserStatus",
            ...
            switch (tag) {
                ...
                case "GetQNupTokenOutput":
                    return {
                        ...
                        path: entity.path,
                        osskeyId: entity.osskeyId,
                        ossPolicy: entity.ossPolicy,
                        ossSign: entity.ossSign,
...
(function (RongIMLib) {
    var Navigation = (function () {
        ...
        Navigation.prototype.getNaviSuccess = function (result, naviUrl) {
            ...
            storage.setItem('upload_config', result.ossConfig);
            //替换本地存储的导航信息 
    ...
    var ServerDataProvider = (function () {
        ...
        */
        ...
        ServerDataProvider.prototype.getFileToken = function (fileType, callback, fileName) {
            ...
            var ossConfig = RongIMLib.RongIMClient._storageProvider.getItem('upload_config') || '{}';
        ...
        ServerDataProvider.prototype.getFileUrl = function (fileType, fileName, oriName, callback, uploadType, data) {
            ...
            if (uploadType === RongIMLib.UploadType.QINIU) {
                ...
                var modules = new RongIMLib.RongIMClient.Protobuf.GetDownloadUrlInput();
                var downloadOutput = 'GetDownloadUrlOutput';
                var topicPosition = 32;
            }
            modules.setType(fileType);
            modules.setKey(fileName);
            if (oriName) {
            ...
            RongIMLib.RongIMClient.bridge.queryMsg(topicPosition, RongIMLib.MessageUtil.ArrayForm(modules.toArrayBuffer()), RongIMLib.Bridge._client.userId, {
                onSuccess: function (data) {
                    setTimeout(function () {
                        callback.onSuccess(data);
                    });
        ...
        */
        ...
        ServerDataProvider.prototype.deleteLocalMessagesByTimestamp = function (conversationType, targetId, timestamp, cleanSpace, callback) {
            callback.onSuccess(true);
        };
...
(function (RongIMLib) {
    var VCDataProvider = (function () {
        ...
        VCDataProvider.prototype.deleteLocalMessagesByTimestamp = function (conversationType, targetId, timestamp, cleanSpace, callback) {
            try {
                this.useConsole && console.log('deleteLocalMessagesByTimestamp');
                this.addon.deleteMessagesByTimestamp(conversationType, targetId, timestamp, cleanSpace);
                callback.onSuccess(true);
            }
            catch (e) {
                callback.onError(e);
