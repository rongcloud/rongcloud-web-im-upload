 ...
 * @rongcloud/imlib-v2
 * Version: v2.6.0
 * CommitId: 2f375c8ba58763d8f4d3b7a74741c4657d09bae0
 * Date: Fri Dec 04 2020 14:21:58 GMT+0800 (GMT+08:00)
...
var RongIMLib = (function (exports) {
    ...
    var methods = (_methods = {}, _defineProperty(_methods, LogLevel.DEBUG, console.debug.bind(console)), _defineProperty(_methods, LogLevel.INFO, console.info.bind(console)), _defineProperty(_methods, LogLevel.WARN, console.warn.bind(console)), _defineProperty(_methods, LogLevel.ERROR, console.error.bind(console)), _methods);
    ...
    var JSEngine = function (_AEngine) {
      ...
      _createClass(JSEngine, [{
        ...
        value: function _rejoinChrm() {
          return __awaiter(this, void 0, void 0, regeneratorRuntime.mark(function _callee27() {
    ...
    var CPPEngine = function (_AEngine2) {
      ...
      function CPPEngine(_runtime, _appkey, _watcher, _apiVersion, _cppProtocol, _options) {
        ...
        _this81 = _super19.call(this, _runtime, _appkey, _watcher, _apiVersion, _options);
        _this81._cppProtocol = _cppProtocol;
        _this81._connectionStatus = ConnectionStatus$1.DISCONNECTED;
        _this81._promiseHandler = {};
        _this81._customMessageType = {};
  
        _this81.init(_appkey, {
          version: _apiVersion,
          dbPath: _options.dbPath || '',
          navi: _options.navigators[0] || ''
        });
  
        _this81._setConnectionStatusListener(_watcher.status);
  
        _this81._setOnReceiveMessageListener(_watcher.message);
  
        _this81._setConversationStatusListener(_watcher.conversation);
      ...
      _createClass(CPPEngine, [{
        ...
        value: function _setConnectionStatusListener(listener) {
          ...
          this._cppProtocol.setConnectionStatusListener(function (status) {
            ...
            var isConnected = this._connectionStatus === ConnectionStatus$1.CONNECTING;
            var connectionStatus;
    ...
    var APIContext = function () {
      ...
      _createClass(APIContext, [{
        ...
        key: "getFileUrl",
        value: function getFileUrl(fileType, uploadMethod, fileName, originName, uploadRes) {
    ...
    {
      logger.warn('RCEngineVersion:', "4.0.2");
      logger.warn('VersionCode:', "2f375c8ba58763d8f4d3b7a74741c4657d09bae0");
    }
    ...
    ***************************************************************************** */
    ...
    const v2Storage = new AppStorage(runtime$2, 'API-V2');
    ...
    */
    function tranToV2Message(message) {
        let { conversationType, targetId, senderUserId, content, messageType, messageUId, messageDirection, isOffLineMessage: offLineMessage, sentTime, receivedStatus, receivedTime, canIncludeExpansion, disableNotification, expansion, messageId, sentStatus } = message;
    ...
    */
    ...
    class IMClient {
        constructor(_context, _isCPPMode) {
            this._context = _context;
        ...
        */
        ...
        getConversationUnreadCount(conversationType, callback) {
            throw todo('getConversationUnreadCount');
        }
        /**
         * 删除指定类型会话，该方法已弃用
         * @description
         ...
         */
        clearConversations(callback) {
            if (this._isCPPMode) {
                this._context.clearConversations().then(code => {
                    if (code === ErrorCode$1.SUCCESS) {
            ...
            logger$1.error('Method is only available in cppProtocol mode');
        }
        /**
         * 清除指定会话未读数
         * @param conversationType
        ...
        sendMessage(conversationType, targetId, msg, callback, isMentioned, pushContent, pushData, methodType, options) {
            ...
            this._context.sendMessage(conversationType, targetId, sendOptions).then(({ code, data }) => {
                if (code === ErrorCode$1.SUCCESS) {
                    ...
                    handleRRReqMsg(tranToV2Message(data), this._context.getCurrentUserId());
                }
                else {
                    callback.onError(code);
                }
        ...
        */
        insertMessage(conversationType, targetId, content, callback) {
            ...
            this._context.insertMessage(conversationType, targetId, senderUserId, objectName, msgContent, messageDirection).then(({ code, data }) => {
                if (code === ErrorCode$1.SUCCESS) {
                    callback.onSuccess(tranToV2Message(data));
                }
                else {
         ...
         * @param callback
        */
        deleteLocalMessages(conversationType, targetId, messageIds, callback) {
            assertCPPMode(this._isCPPMode);
        ...
        */
        deleteLocalMessagesByTimestamp(conversationType, targetId, timestamp, cleanSpace, callback) {
            this._context.deleteMessagesByTimestamp(conversationType, targetId, timestamp, cleanSpace).then(code => {
                if (code === ErrorCode$1.SUCCESS) {
                    callback.onSuccess(true);
                }
                else {
        ...
        */
        searchConversationByContent(keyword, callback, conversationTypes) {
            assertCPPMode(this._isCPPMode);
            this._context.searchConversationByContent(keyword, conversationTypes).then(({ code, data }) => {
                const conversationList = [];
                data = data || [];
                if (code === ErrorCode$1.SUCCESS) {
                    data.forEach((item) => {
        ...
        */
        getUnreadMentionedMessages(conversationType, targetId) {
            assertCPPMode(this._isCPPMode);
            const messages = this._context.getUnreadMentionedMessages(conversationType, targetId);
    ...
    var RongIMClient = {
        ...
        init(appkey, cppProtocol, options = {}) {
            context = APIContext.init(runtime$2, {
                appkey,
                apiVersion: "2.6.0",
            ...
            imClient = new IMClient(context, !!cppProtocol);
        },
        /**
    ...
    */
    ...
    const ConnectionState = ConnectResultCode;
