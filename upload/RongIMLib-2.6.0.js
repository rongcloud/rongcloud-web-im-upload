 ...
 * @rongcloud/imlib-v2
 * Version: v2.6.0
 * CommitId: 71235ce0b35998aa6009554b1d5104fc2e67e869
 * Date: Thu Dec 10 2020 14:26:01 GMT+0800 (GMT+08:00)
...
var RongIMLib = (function (exports) {
          ...
          self._timerId = setTimeout(function () {
            ...
            if (self._hasPingRes) {
              ...
              self._heartbeatTimeoutId = setTimeout(function () {
                ...
                self._connectionListener.call(cppEngine, ErrorCode$1.NETWORK_ERROR);
              }.bind(this), 90 * 1000);
            }
          }.bind(this), time);
        }.bind(this);
...

  {
    ...
    logger.warn('VersionCode:', "71235ce0b35998aa6009554b1d5104fc2e67e869");
  }
  ...
  class IMClient {
      ...
      */
      searchMessageByContent(conversationType, targetId, keyword, timestamp, count, total, callback) {
          assertCPPMode(this._isCPPMode);
          this._context.searchMessageByContent(conversationType, targetId, keyword, timestamp, count, total).then(({ code, data }) => {
              const v2Messages = [];
              data = data || [];
              if (code === ErrorCode$1.SUCCESS) {
                  data.forEach((item) => {
