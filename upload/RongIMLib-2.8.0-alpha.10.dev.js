/*
 * RCEngine - v4.3.0-alpha.9
 * CommitId - 0dfe5f9a0ca468ae98b3624549c631d0f827e3b8
 * Tue Mar 16 2021 15:38:18 GMT+0800 (中国标准时间)
    ...
    class JoinedChrmManager {
        ...
        get() {
            ...
            try {
                ...
                logger.error('parse rejoined chrm infos error', err, data);
                infos = {};
            }
            return infos;
        }
    ...
    */
    ...
    class APIContext {
        constructor(_runtime, options) {
             ...
             */
            this.coreVersion = "4.3.0-alpha.9";
        ...
        static init(runtime, options) {
            ...
            {
                logger.warn('VersionCode:', "0dfe5f9a0ca468ae98b3624549c631d0f827e3b8");
            }
...
/*
 * RongIMLib - v2.8.0-alpha.10
 * CommitId - 7dcbd38280167543fbd6a40dc216fff8ef57e959
 * Tue Mar 16 2021 15:39:53 GMT+0800 (中国标准时间)
 * ©2020 RongCloud, Inc. All rights reserved.
 */
(function (global, factory) {
    ...
    */
    function tranToV2Conversation(conversation) {
        ...
        return {
            ...
            latestMessageId: v2ReceicedMessage === null || v2ReceicedMessage === void 0 ? void 0 : v2ReceicedMessage.messageId,
            objectName: v2ReceicedMessage === null || v2ReceicedMessage === void 0 ? void 0 : v2ReceicedMessage.messageType,
            sentTime: v2ReceicedMessage === null || v2ReceicedMessage === void 0 ? void 0 : v2ReceicedMessage.sentTime,
            isTop,
            notificationStatus,
            receivedStatus: v2ReceicedMessage === null || v2ReceicedMessage === void 0 ? void 0 : v2ReceicedMessage.receivedStatus
        };
    }
    /**
     * 根据底层会话构建 V2 会话
    ...
    */
    ...
    class ChannelClient {
        ...
        getConversation(conversationType, targetId, callback) {
            ...
            (() => __awaiter(this, void 0, void 0, function* () {
                const { code, data: conversation } = yield this._context.getConversation(conversationType, targetId, this.channelId);
                if (code !== engine.ErrorCode.SUCCESS) {
                    callback.onError(code);
                    return;
                }
                callback.onSuccess(conversation ? tranToV2Conversation(conversation) : null);
            }))();
        }
        /**
         * 删除指定会话
         ...
         * @param callback
        */
        insertMessage(conversationType, targetId, content, callback, options = {}) {
            const { senderUserId, objectName, content: msgContent, messageDirection, messageUId, canIncludeExpansion, expansion, disableNotification, sentTime, sentStatus } = content;
            ...
            this._context.insertMessage(conversationType, targetId, insertOptions).then(({ code, data }) => {
                if (code === engine.ErrorCode.SUCCESS) {
                    onSuccessHook(callback.onSuccess, tranToV2Message(data));
                }
                else {
    ...
    class IMClient {
        ...
        */
         ...
         * 2. 上传请求前调用，此时 `httpMethod` 值应为 `PUT`，`queryString` 值为 `partNumber={partamNumer}&uploadId={uploadId}`
         * 3. 上传结束前调用，此时 `httpMethod` 值应为 `POST`，`queryString` 值为 `uploadId={uploadId}`
         * 4. filename在开始阶段没有传值，后面两个步骤的filename为getFileToken生成的filename
         * @returns
         */
        getFileToken(fileType, callback, fileName, httpMethod, queryString) {
            engine.assert('fileType', fileType, engine.AssertRules.NUMBER, true);
            engine.assert('fileName', fileName, engine.AssertRules.STRING);
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            this._context.getFileToken(fileType, fileName, httpMethod, queryString).then(callback.onSuccess).catch(callback.onError);
        }
        /**
         * 获取文件地址
         * @param fileType 上传类型
         ...
         */
        getFileUrl(fileType, fileName, saveName, callback, uploadRes, serverType) {
            engine.assert('fileType', fileType, engine.AssertRules.NUMBER, true);
            ...
            engine.assert('uploadRes', uploadRes, engine.AssertRules.OBJECT);
            this._context.getFileUrl(fileType, fileName, saveName, uploadRes, serverType).then(callback.onSuccess).catch(callback.onError);
        }
        /**
         * 创建标签
         * @param tag 标签信息
            ...
            this._context.callExtra(method, ...args).then((res) => {
                ...
                if (code === engine.ErrorCode.SUCCESS) {
                    if (method === 'getConversationsByPage') {
                        data.forEach((item) => {
                            item.latestMessage = item.latestMessage ? tranToV2Message(item.latestMessage) : null;
                        });
                    }
        ...
        */
        insertMessage(conversationType, targetId, content, callback, options = {}) {
            ...
            engine.assert('callback', callback, engine.AssertRules.CALLBACK);
            this.assertCPPMode(() => {
                this._defaultChannelClient.insertMessage(conversationType, targetId, content, callback, options);
    ...
    /**
     * @deprecated
     * 为兼容 2.5 及之前的版本，开发者可能使用该类型做消息类型判断
     */
    const MessageType = {
