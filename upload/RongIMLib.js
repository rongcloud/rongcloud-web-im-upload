/*
 * RongIMLib - v2.8.0-alpha.5
 * CommitId - 79b04bcf365b4cf78e932c85d1ebb9cfb4b5c641
 * Thu Feb 25 2021 12:10:29 GMT+0800 (GMT+08:00)
...
(function (global, factory) {
     ...
     * CommitId - c9849d8a28f2db62af7b9180bfa35332a90080b3
     * Thu Feb 25 2021 12:08:00 GMT+0800 (GMT+08:00)
     * ©2020 RongCloud, Inc. All rights reserved.
     */
    var ReceivedStatus;
  ...
  `;
        ...
        return __awaiter(this, void 0, void 0, function* () {
          ...
          for (let i = 0, len = validHosts.length; i < len; i += 1) {
            ...
            const code = yield new Promise(resolve => {
              ...
              socket.onOpen(() => logger.debug('websocket open =>', url)); // ConnAck 超时
    ...
    */
    ...
    class JSEngine extends AEngine {
      ...
      connect(token, naviInfo) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          if (code === ErrorCode$1.SUCCESS) {
            ...
            this._conversationManager.startPullConversationStatus(0); // 初始化加入 chrm 的信息
      ...
      _receiveSettingNotify(signal) {// 持续迭代中，注释防止 comet 报错
      ...
      */
      ...
      _pullChrmMsg(chrmId, count = 10) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          chrmInfo.pulling = false; // 清除无效时间戳
    ...
    class APIContext {
      ...
      static init(runtime, options) {
        ...
        {
          logger.warn('VersionCode:', "c9849d8a28f2db62af7b9180bfa35332a90080b3");
        }
    ...
    */
    ...
    function tranToV2Conversation(conversation) {
      ...
      var v2ReceicedMessage = tranToV2Message(latestMessage);
      var objectName = v2ReceicedMessage.messageType,
          sentTime = v2ReceicedMessage.sentTime,
          receivedStatus = v2ReceicedMessage.receivedStatus;
      return {
        channelId: channelId || '',
        conversationType: conversationType,
        targetId: targetId,
    ...
    */
    ...
    function tranToSendOptions(options, isMentioned, msg) {
      var _ref = options || {},
          ...
          isVoipPush = _ref.isVoipPush,
          disableNotification = _ref.disableNotification,
          isFilerWhiteBlacklist = _ref.isFilerWhiteBlacklist,
          expansion = _ref.expansion,
          canIncludeExpansion = _ref.canIncludeExpansion,
          pushConfig = _ref.pushConfig;
      ...
      if (isMentioned) {
        var _ref2 = msg || {},
            _ref2$content$mention = _ref2.content.mentionedInfo,
            userIdList = _ref2$content$mention.userIdList,
            type = _ref2$content$mention.type;
    ...
    var ChannelClientProxy = /*#__PURE__*/function () {
      function ChannelClientProxy(_context, channelId, _isCPPMode) {
        _classCallCheck(this, ChannelClientProxy);
      ...
      _createClass(ChannelClientProxy, [{
        ...
        value: function sendMessage(conversationType, targetId, msg, callback, isMentioned, pushContent, pushData, options) {
          ...
          this._context.sendMessage(conversationType, targetId, sendOptions).then(function (_ref5) {
            var code = _ref5.code,
                data = _ref5.data;
  
            if (code === ErrorCode$1.SUCCESS) {
              callback.onSuccess(tranToV2Message(data));
              handleRRReqMsg(tranToV2Message(data), _this2._context.getCurrentUserId());
            } else {
              callback.onError(code);
            }
        ...
        */
        ...
        value: function getRemoteHistoryMessages(conversationType, targetId, timestamp, count, callback) {
          this._context.getRemoteHistoryMessages(conversationType, targetId, timestamp, count, 0, this.channelId).then(function (_ref10) {
        ...
        value: function searchMessageByContent(conversationType, targetId, keyword, timestamp, count, total, callback) {
          this._context.searchMessageByContent(conversationType, targetId, keyword, timestamp, count, total, this.channelId).then(function (_ref12) {
            ...
            if (code === ErrorCode$1.SUCCESS) {
              ...
              callback.onSuccess(v2Messages, _count);
            } else {
              callback.onError(code);
            }
          }, callback.onError);
    ...
    var IMClient = /*#__PURE__*/function () {
      function IMClient(_context) {
        ...
        this._defaultChannelClient = new ChannelClientProxy(_context, '', this._isCPPMode);
      }
      /**
       * 协议栈方法校验
       */
      ...
      _createClass(IMClient, [{
        ...
        value: function assertCPPMode(method, methodName, callback) {
          if (!this._isCPPMode) {
            ...
            logger$1.error("'".concat(methodName, "' is unusable!"));
            return;
          }
        ...
        */
        ...
        value: function getChannel(channelId) {
          if (!this._isCPPMode) {
            logger$1.error('getChannel method is only available in protocol stack mode');
            return null;
          }
          ...
          if (channelId.length > 20) {
            logger$1.error('The channelId cannot exceed 20 characters');
            return null;
          }
          ...
          if (Object.keys(this._channelClient).length > 1000) {
            logger$1.error('Only 1000 channels can be obtained');
            return null;
          }
  
          this._channelClient[channelId] = new ChannelClientProxy(this._context, channelId, this._isCPPMode);
          return this._channelClient[channelId];
        }
        /**
        ...
        */
        ...
        value: function deleteChannels(channelIds) {
          ...
          if (!this._isCPPMode) {
            logger$1.error('deleteChannels method is only available in protocol stack mode');
            return null;
          }
        ...
        */
        ...
        value: function getConversationUnreadCount(conversationType, callback) {
          logger$1.error('Method is deprecated');
        }
        /**
         * 删除指定类型会话，该方法已弃用
         * @description
        ...
        */
        ...
        value: function callExtra(method, callback) {
          ...
          (_this$_context = this._context).callExtra.apply(_this$_context, [method].concat(args)).then(function (res) {
            ...
            callback.onError && callback.onError(code);
          });
        }
        /* ====================== CPP 独有接口增加 ======================== */
        ...
        */
        ...
        value: function getUserStatus(userId, callback) {
          ...
          assert('callback', callback, AssertRules.CALLBACK);
          this.assertCPPMode(function () {
            _this4._context.getUserStatus(userId).then(function (_ref7) {
              var code = _ref7.code,
                  data = _ref7.data;
        ...
        */
        ...
        value: function getBlacklist(callback) {
          ...
          assert('callback', callback, AssertRules.CALLBACK);
          this.assertCPPMode(function () {
            _this7._context.getBlacklist().then(function (_ref8) {
              var code = _ref8.code,
                  data = _ref8.data;
        ...
        */
        ...
        value: function getBlacklistStatus(userId, callback) {
          ...
          assert('callback', callback, AssertRules.CALLBACK);
          this.assertCPPMode(function () {
            _this8._context.getBlacklistStatus(userId).then(function (_ref9) {
              var code = _ref9.code,
                  data = _ref9.data;
        ...
        */
        ...
        value: function getRemoteHistoryMessages(conversationType, targetId, timestamp, count, callback) {
          ...
          assert('callback', callback, AssertRules.CALLBACK);
          this.assertCPPMode(function () {
            _this10._defaultChannelClient.getRemoteHistoryMessages(conversationType, targetId, timestamp, count, callback);
        ...
        */
        ...
        value: function getMessage(messageId, callback) {
          ...
          assert('callback', callback, AssertRules.CALLBACK);
          this.assertCPPMode(function () {
            _this14._context.getMessage(messageId).then(function (_ref10) {
              var code = _ref10.code,
                  data = _ref10.data;
        ...
        */
        ...
        value: function getUnreadMentionedMessages(conversationType, targetId) {
          if (!this._isCPPMode) {
            logger$1.error('getUnreadMentionedMessages method is not supported in a browser!');
            return null;
          }
        ...
        */
        ...
        value: function getRTCUserInfoList(room, callback) {
          this._context.getRTCUserInfoList(room.id).then(function (_ref11) {
            var code = _ref11.code,
                data = _ref11.data;
        ...
        value: function getRTCUserList(room, callback) {
          this._context.getRTCUserList(room.id).then(function (_ref12) {
            var code = _ref12.code,
                data = _ref12.data;
        ...
        value: function getRTCRoomInfo(room, callback) {
          this._context.getRTCRoomInfo(room.id).then(function (_ref13) {
            var code = _ref13.code,
                data = _ref13.data;
        ...
        value: function joinRTCRoom(room, callback) {
          ...
          this._context.joinRTCRoom(room.id, mode).then(function (_ref14) {
        ...
        value: function getRTCData(roomId, keys, isInner, apiType, callback) {
          this._context.getRTCData(roomId, keys, isInner, apiType).then(function (_ref15) {
        ...
        value: function getRTCToken(room, callback) {
          this._context.getRTCToken(room.id, room.mode, room.broadcastType).then(function (_ref16) {
    ...
    */
    ...
    var MentionedType$3 = MentionedType$2;
    ...
    exports.MentionedType = MentionedType$3;
